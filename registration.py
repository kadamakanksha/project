...
def upload():
    ...
    call(["python","coordinate_in_CSV.py"])
#from subprocess import call
...
frame = tk.LabelFrame(window, text="", width=600, height=680, bd=5, font=('times', 14, ' bold '),bg="antiquewhite2")
...
# btn = tk.Button(frame, text="Upload Hand Geometry", bg="red",font=("",20),fg="white", width=20, height=1, command=insert)
# btn.place(x=230, y=480)

btn = tk.Button(frame, text="Register", bg="red",font=("",20),fg="white", width=9, height=1, command=insert)
btn.place(x=230, y=550)
